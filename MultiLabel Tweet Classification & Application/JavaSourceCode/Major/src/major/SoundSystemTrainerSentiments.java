...
public class SoundSystemTrainerSentiments {
    private String charset;
    private String trainDirectory;
    private String outFile;

    public SoundSystemTrainerSentiments() {
        charset = SoundSystemConfig.charset;
        trainDirectory = SoundSystemConfig.trainDirectory;
        outFile = SoundSystemConfig.classifierPath;
    }

    public SoundSystemTrainerSentiments(String charset, String trainDirectory, String outFile) {
    ...
    public void Train() throws IOException, ClassNotFoundException {
        ...
        System.out.println("This is SoundSystem Sentiment trainer ");
