 ...
 * @author Pranav Jain
 */
public class TelevisionTweetsFormConsumer extends javax.swing.JFrame {
String brand1,brand2;
        float CameraPolarity1,ServiceAndSupportPolarity1,QuestPolarity1,FeaturesPolarity1,MentionPolarity1;
        float CameraPolarity2,ServiceAndSupportPolarity2,QuestPolarity2,FeaturesPolarity2,MentionPolarity2;
int deals,deals2;
  int totalpos2=0,totalneg2=0,totalneu2=0;
     ...
     */
    public TelevisionTweetsFormConsumer(String b1,String b2) {
        brand1=b1;
        brand2=b2;
        initComponents();
    ...
    try {
        fout1 = new FileOutputStream("DatasetConsumer\\Television"+brand1+".txt");
    } catch (FileNotFoundException ex) {
        Logger.getLogger(TelevisionTweetsFormConsumer.class.getName()).log(Level.SEVERE, null, ex);
    }
   BufferedOutputStream bout=new BufferedOutputStream(fout1);  
    ...
    System.out.println("Count: " + count);  
        ...
        OFPos1.setText("=" + posFeatures);
        OFNeg1.setText("=" + negFeatures);
        OFNeu1.setText("=" + neuFeatures);
        ...
        DealNum1.setText("=" + deals);
         ...
         totalpos1=posServiceAndSupport + posQuest + posFeatures + posQuest + posMention;
        totalneg1=negServiceAndSupport + negQuest + negFeatures + negQuest + negMention;
        totalneu1=neuServiceAndSupport + neuQuest + neuFeatures + neuQuest + neuMention;
        ...
        try {
        fout3 = new FileOutputStream("DatasetConsumer\\Television"+brand1+"Sentiments.txt");
    } catch (FileNotFoundException ex) {
        Logger.getLogger(TelevisionTweetsFormConsumer.class.getName()).log(Level.SEVERE, null, ex);
    }
   ...
   FileOutputStream fout2=null;  
    try {
        fout2 = new FileOutputStream("DatasetConsumer\\Television"+brand2+".txt");
   ...
   BufferedOutputStream bout2=new BufferedOutputStream(fout2);  
        ...
        try {
            ...
            for (int i = 0; i < ts2.size() && count2 != LIMIT; i++) {
                 ...
                 if(text2.toLowerCase().contains("deal") || text2.toLowerCase().contains("offer") || text2.toLowerCase().contains("deals") || text2.toLowerCase().contains("offers"))
                {
                 ...
                 if( text2.toLowerCase().contains("win") || text2.toLowerCase().contains("click") ||  text2.toLowerCase().contains("bid") || text2.toLowerCase().contains("free"))
                {
                    String name2 = t2.getUser().getScreenName();
                    txtTrendingTweets2.append(name2 + " : " + text2 + "\n" + "Sentiment: Neutral \n Topic: Advertisement");
                    txtTrendingTweets2.append("\n-----------------------------------------------------------------------------------\n");
    ...
    System.out.println("Count: " + count2);  
        ...
        DealNum2.setText("=" + deals2);
          ...
          totalpos2=posServiceAndSupport2 + posQuest2 + posFeatures2 + posQuest2 + posMention2;
        totalneg2=negServiceAndSupport2 + negQuest2 + negFeatures2 + negQuest2 + negMention2;
        totalneu2=neuServiceAndSupport2 + neuQuest2 + neuFeatures2 + neuQuest2 + neuMention2;
      ...
      FileOutputStream fout4=null;  
        ...
        try {
        fout4 = new FileOutputStream("DatasetConsumer\\Television"+brand2+"Sentiments.txt");
    } catch (FileNotFoundException ex) {
        Logger.getLogger(TelevisionTweetsFormConsumer.class.getName()).log(Level.SEVERE, null, ex);
    }
   BufferedOutputStream bout4=new BufferedOutputStream(fout4);  
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        TelevisionResultformConsumer f=new TelevisionResultformConsumer(brand1,brand2,ServiceAndSupportPolarity1,QuestPolarity1,FeaturesPolarity1,MentionPolarity1,
       ServiceAndSupportPolarity2,QuestPolarity2,FeaturesPolarity2,MentionPolarity2,deals,deals2);
        f.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelevisionTweetsFormConsumer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
               // new TelevisionTweetsFormConsumer().setVisible(true);
            }
        });
    }
