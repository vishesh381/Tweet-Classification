 ...
 * @author Pranav Jain
 */
public class TelevisionTopicClassifier {
     String[] categories;  
    LMClassifier class1;  
    ...
    */
    public TelevisionTopicClassifier() {  
    try {  
       ...
       */
       class1= (LMClassifier) AbstractExternalizable.readObject(new File("TelevisionclassifierTopic.txt"));
