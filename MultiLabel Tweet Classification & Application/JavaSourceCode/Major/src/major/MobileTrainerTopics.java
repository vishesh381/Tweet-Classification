...
public class MobileTrainerTopics {
    private String charset2;
    private String trainDirectory2;
    private String outFile2;

    public MobileTrainerTopics() {
        charset2 = MobileConfig.charset2;
        trainDirectory2 = MobileConfig.trainDirectory2;
        outFile2 = MobileConfig.classifierPath2;
    }

    public MobileTrainerTopics(String charset, String trainDirectory, String outFile) {
    ...
    public void Train() throws IOException, ClassNotFoundException {
        ...
        clazz2 = DynamicLMClassifier.createNGramProcess(categories2, nGram);
            ...
            */
         System.out.println("This is Mobile Topic trainer");
