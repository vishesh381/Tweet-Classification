 ...
 * @author Pranav Jain
 */
public class SoundSystemTopicClassifier {
     String[] categories;  
    LMClassifier class1;  
    ...
    */
    public SoundSystemTopicClassifier() {  
    try {  
       ...
       */
       class1= (LMClassifier) AbstractExternalizable.readObject(new File("SoundSystemclassifierTopic.txt"));
