 ...
 * @author Pranav Jain
 */
public class TelevisionSentimentClassifier {
     String[] categories;  
    LMClassifier class1;  
    ...
    */
    public TelevisionSentimentClassifier() {  
    try {  
       ...
       */
       class1= (LMClassifier) AbstractExternalizable.readObject(new File("TelevisionclassifierSentiments.txt"));
