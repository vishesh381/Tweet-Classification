...
public class MobileTrainerSentiments {
    private String charset;
    private String trainDirectory;
    private String outFile;

    public MobileTrainerSentiments() {
        charset = MobileConfig.charset;
        trainDirectory = MobileConfig.trainDirectory;
        outFile = MobileConfig.classifierPath;
    }

    public MobileTrainerSentiments(String charset, String trainDirectory, String outFile) {
    ...
    public void Train() throws IOException, ClassNotFoundException {
        ...
        System.out.println("This is Mobile Sentiment trainer");
