 ...
 * @author Ruchi
 */
public class TelevisionResultformCompany extends javax.swing.JFrame {
String brand1;
    /**
     * Creates new form MobileResultform
     */
    public TelevisionResultformCompany(String s1,float ServiceAndSupportPolarity1,
            float QuestPolarity1,float OtherFeaturesPolarity1,float MentionPolarity1,int totalpos,
            int totalneg,int totalneu,int deals) {
        brand1=s1;
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(140, 140, 140)
                                .addComponent(deals1, javax.swing.GroupLayout.DEFAULT_SIZE, 82, Short.MAX_VALUE))
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(82, 82, 82)
                        .addComponent(BName1, javax.swing.GroupLayout.PREFERRED_SIZE, 208, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(18, 18, 18)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       Scanner sc1 = null;
    try {
        sc1 = new Scanner(new File("DatasetCompany\\Week1 Television"+brand1+"Sentiments.txt"));
    ...
    while (sc1.hasNextLine()) {
        ...
        while (s1.hasNext()) {
          ...
          Scanner sc2 = null;
    try {
        sc2 = new Scanner(new File("DatasetCompany\\Week2 Television"+brand1+"Sentiments.txt"));
    } catch (FileNotFoundException e) {
        e.printStackTrace();  
    }
    int x2=0;
    ...
    while (sc2.hasNextLine()) {
     ...
     Scanner sc3 = null;
    try {
        sc3 = new Scanner(new File("DatasetCompany\\Television"+brand1+"Sentiments.txt"));
    } catch (FileNotFoundException e) {
        e.printStackTrace();  
    }
    int x3=0;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelevisionResultformCompany.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new MobileResultformCompany().setVisible(true);
            }
        });
    }
