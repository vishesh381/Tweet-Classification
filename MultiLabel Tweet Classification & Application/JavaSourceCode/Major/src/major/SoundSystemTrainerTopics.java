...
public class SoundSystemTrainerTopics {
    private String charset2;
    private String trainDirectory2;
    private String outFile2;

    public SoundSystemTrainerTopics() {
        charset2 = SoundSystemConfig.charset2;
        trainDirectory2 = SoundSystemConfig.trainDirectory2;
        outFile2 = SoundSystemConfig.classifierPath2;
    }

    public SoundSystemTrainerTopics(String charset, String trainDirectory, String outFile) {
    ...
    public void Train() throws IOException, ClassNotFoundException {
        ...
        clazz2 = DynamicLMClassifier.createNGramProcess(categories2, nGram);
            ...
            */
         System.out.println("This is SoundSystem Topic trainer");
