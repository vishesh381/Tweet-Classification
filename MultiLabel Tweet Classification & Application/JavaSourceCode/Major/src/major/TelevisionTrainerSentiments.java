...
public class TelevisionTrainerSentiments {
    private String charset;
    private String trainDirectory;
    private String outFile;

    public TelevisionTrainerSentiments() {
        charset = TelevisionConfig.charset;
        trainDirectory = TelevisionConfig.trainDirectory;
        outFile = TelevisionConfig.classifierPath;
    }

    public TelevisionTrainerSentiments(String charset, String trainDirectory, String outFile) {
    ...
    public void Train() throws IOException, ClassNotFoundException {
        ...
        System.out.println("This is Television Sentiment trainer");
