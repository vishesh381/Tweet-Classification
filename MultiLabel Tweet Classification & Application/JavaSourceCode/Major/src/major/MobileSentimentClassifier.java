 ...
 * @author Pranav Jain
 */
public class MobileSentimentClassifier {
     String[] categories;  
    LMClassifier class1;  
    ...
    */
    public MobileSentimentClassifier() {  
    try {  
       ...
       */
       class1= (LMClassifier) AbstractExternalizable.readObject(new File("MobileclassifierSentiments.txt"));
