 ...
 * @author Pranav Jain
 */
public class SoundSystemSentimentClassifier {
     String[] categories;  
    LMClassifier class1;  
    ...
    */
    public SoundSystemSentimentClassifier() {  
    try {  
       ...
       */
       class1= (LMClassifier) AbstractExternalizable.readObject(new File("SoundSystemclassifierSentiments.txt"));
